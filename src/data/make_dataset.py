...
single_file_acc = pd.read_csv(
    "../../data/raw/MetaMotion/MetaMotion/A-bench-heavy_MetaWear_2019-01-14T14.22.49.165_C42732BE255C_Accelerometer_12.500Hz_1.4.4.csv"
)
...
label = f.split("-")[1]
category = f.split("-")[2].rstrip("1234567890").rstrip("_MetaWear_2019")
...
acc_df.drop(["epoch (ms)", "time (01:00)", "elapsed (s)"], inplace=True, axis=1)
gyr_df.drop(["epoch (ms)", "time (01:00)", "elapsed (s)"], inplace=True, axis=1)
# --------------------------------------------------------------
# Turn into function
# --------------------------------------------------------------
