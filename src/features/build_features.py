...
df = pd.read_pickle("../../data/interim/02._outliers_removed_chauvenets.pkl")
...
df[df["set"] == 57]["acc_y"].plot()

df[(df["participant"] == "E") & (df["category"] == "medium") & (df["label"] == "dead")]
...
duration_df.iloc[0] / 5  # Heavy
duration_df.iloc[1] / 10  # Medium
# --------------------------------------------------------------
